  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <Routes>
        ...
        <Route path="/os" element={<ComingSoonPage title="Operating Systems" description="CPU scheduling, memory management, and deadlock visualizations are on the way." />} />
        <Route path="/cn" element={<ComingSoonPage title="Computer Networks" description="Routing algorithms, TCP handshakes, and subnetting visualizations are on the way." />} />
